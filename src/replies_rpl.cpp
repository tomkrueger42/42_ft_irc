...
std::string rpl_channelmodeis( int fd, std::string& channel_name, std::string mode, std::string params )
{
    std::stringstream ss;
...
std::string rpl_notopic( int fd, std::string& channel_name )
{
    std::stringstream ss;
...
std::string rpl_topic( int fd, std::string& channel_name, std::string& topic )
{
    std::stringstream ss;
...
std::string rpl_inviting( int fd, std::string& channel_name, std::string caller, std::string& nick )
{
    std::stringstream ss;
...
std::string rpl_namreply( int fd, std::string nick, std::string channel_name, Members& members )
{
    std::stringstream ss;
